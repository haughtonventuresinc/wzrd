...
const ButtonCheckout = ({ priceId, mode = "payment" }) => {
  ...
  const addPaypalScript = () => {
    ...
    // client id = Ac_Y6w5AyvIjDM7uTK2ksmdQ4nuYHJEgTY4xjI91I8wv-3zKPkmhcPE2MkmXd7okZzxCeJkrUiS3Jt68
    // secret key = EJaM4GKi0OQ1DdZGxnUNGgJtTCSj2oclErJjjrv2AW6DO3yNlpV3beAQ8wfU_pvKkROv8k3vmCzrF3yE
    // url = https://sandbox.paypal.com
    // email = sb-r787z30783215@business.example.com
    // password = yLp*3&jM
    // Sandbox account sb-r787z30783215@business.example.com
    // Access token    access_token$sandbox$qhx73kd79t432b9f$650dd4eb221100797c0a1ac32fb4bce8;
  ...
  // return (
  //   <button
  //     className="btn bg-black text-white hover:text-[#2B3440] btn-block group"
